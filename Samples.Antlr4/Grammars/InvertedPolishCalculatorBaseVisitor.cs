...
/// <summary>
/// This class provides an empty implementation of <see cref="IInvertedPolishCalculatorVisitor{Result}"/>,
...
public partial class InvertedPolishCalculatorBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IInvertedPolishCalculatorVisitor<Result> {
	/// <summary>
	...
	public virtual Result VisitInput([NotNull] InvertedPolishCalculatorParser.InputContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitAddOrMinus([NotNull] InvertedPolishCalculatorParser.AddOrMinusContext context) { return VisitChildren(context); }
	/// <summary>
