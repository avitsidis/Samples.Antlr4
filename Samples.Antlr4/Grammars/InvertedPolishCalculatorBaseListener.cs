...
/// <summary>
/// This class provides an empty implementation of <see cref="IInvertedPolishCalculatorListener"/>,
/// which can be extended to create a listener which only needs to handle a subset
/// of the available methods.
/// </summary>
[System.CodeDom.Compiler.GeneratedCode("ANTLR", "4.7.1")]
[System.CLSCompliant(false)]
public partial class InvertedPolishCalculatorBaseListener : IInvertedPolishCalculatorListener {
	/// <summary>
	/// Enter a parse tree produced by <see cref="InvertedPolishCalculatorParser.input"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterInput([NotNull] InvertedPolishCalculatorParser.InputContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterExpression([NotNull] InvertedPolishCalculatorParser.ExpressionContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterNumber([NotNull] InvertedPolishCalculatorParser.NumberContext context) { }
	/// <summary>
